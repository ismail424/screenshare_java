...
public class App extends Application {
    ...
    private void startApiServer() {
        ...
        get("/screen", (req, res) -> {
            ...
            String base64Image = ScreenShare.captureAndCompressScreenBase64(screenIndex, compressionLevel, maxWidth, maxHeight);
            return base64Image;
        });
        ...
        get("/screen/image", (req, res) -> {
            ...
            byte[] image = ScreenShare.captureAndCompressScreenImage(screenIndex, compressionLevel, maxWidth, maxHeight);
            return image;
