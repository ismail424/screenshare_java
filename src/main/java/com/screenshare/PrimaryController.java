...
public class PrimaryController {
    ...
    private final ObservableList<Resolution> resolutionItems = FXCollections
            .observableArrayList(EnumSet.allOf(Resolution.class));
    private final ObservableList<QualityLevel> qualityLevelItems = FXCollections
            .observableArrayList(EnumSet.allOf(QualityLevel.class));

    @FXML
    Label urlLink;
    @FXML
    ChoiceBox<Resolution> selectResolution;
    @FXML
    ChoiceBox<QualityLevel> selcectionQuality;
    @FXML
    ChoiceBox<String> SelectScreenIndex;
